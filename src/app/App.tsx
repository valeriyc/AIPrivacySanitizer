...
type PIIType = 'names' | 'emails' | 'phones' | 'ssn' | 'creditCards' | 'passwords' | 'addresses' | 'dates' | 'urls' | 'ipAddresses' | 'numbers';
...
const piiConfig: PIIConfig = {
  ...
  addresses: { label: 'Addresses', pattern: /\b\d+\s+[\w\s]+(?:street|st|avenue|ave|road|rd|boulevard|blvd|lane|ln|drive|dr|court|ct|circle|cir|way)\b/gi, placeholder: '[ADDRESS]', minStrength: 30 },
  ...
  names: { label: 'Person Names', pattern: /\b[A-Z][a-z]+\s+[A-Z][a-z]+\b/g, placeholder: '[NAME]', minStrength: 90 },
